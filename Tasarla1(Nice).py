...
# The warnings above is written by the Qt5 designer. 
...
from FunctionsForInterfaceQt5 import plotGraph
# This function explained in the FunctionsForInterfaceQt5.py file.
...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        ## Label (It is not used and probably will not be used)
    ...
    ## Adds the line to the table (shortcut: ctrl + A)
    def addLine(self):
    ...
    # Deletes a line from table (shortcut: ctrl + delete)
    def deleteLine(self):
    ...
    # This function takes the data as pandas dataframe, handles with some errors, then shows the graph.
    def showGraph(self):
        try:
